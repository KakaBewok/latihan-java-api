...
public class RedisConfig {
	...
	public RedisCacheManager cacheManager() {
		...
		return RedisCacheManager.builder(redisConnectionFactory()).cacheDefaults(cacheConfig)
				...
				.withCacheConfiguration("tutorials_published", myDefaultCacheConfig(Duration.ofMinutes(5)))
				.withCacheConfiguration("tutorial", myDefaultCacheConfig(Duration.ofMinutes(2))).build();
	}
